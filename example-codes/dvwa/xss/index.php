...
switch( dvwaSecurityLevelGet() ) {
	case 'low':
		$vulnerabilityFile = 'xss_r_low.php';
		break;
	case 'medium':
		$vulnerabilityFile = 'xss_r_medium.php';
		break;
	case 'high':
		$vulnerabilityFile = 'xss_r_high.php';
		break;
	default:
		$vulnerabilityFile = 'xss_r_impossible.php';
		break;
}

require_once DVWA_WEB_PAGE_TO_ROOT . "example-codes/dvwa/xss/{$vulnerabilityFile}";
